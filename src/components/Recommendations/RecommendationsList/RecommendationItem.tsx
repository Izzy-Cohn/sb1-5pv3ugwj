...
export function RecommendationItem({ rank, name, brand, description, imageUrl, price, index }: RecommendationItemProps) {
    ...
    >
      ...
      <div className="flex-1">
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <Link to={`/${formattedCategory}/recommendations/${slug}/${formattedName}`}>
            <motion.button
